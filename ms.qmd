...
Given the very high inter-factor correlations reported in the Construct Validity section, we investigated whether a bifactor structure -- a single general factor alongside domain-specific factors -- might better characterize the data.
