...
Reflecting the pilot nature of this data collection, sample sizes and exclusion rates are imbalanced across sites: uniandes-co-bogota contributes the majority of the pooled sample reflecting that data collection began there first and expanded rapidly, but also saw a higher exclusion rate due to technical issues in early releases of the software, and intermittent connectivity issues (the latter more so in uniandes-co-rural). 
